...
import com.juxing.pojo.wechatPojo.WeixinUserInfo;
...
public class CommonUtil {
    ...
    // 长链接转短链接地址(post)
    public final static String long2shortUrl = "https://api.weixin.qq.com/cgi-bin/shorturl?access_token=ACCESS_TOKEN";
     ...
     * @return
     */
    public static JSONObject long2short(String access_token, String long_url) {

        String requestUrl = long2shortUrl.replace("ACCESS_TOKEN",access_token);
    ...
    /**
     * 获取jsapi_ticket
     * 原文：https://blog.csdn.net/qq_36627509/article/details/79745328
     *
     * @param accessToken
     * @return
     */
    ...
    public static WeixinUserInfo getUserInfo(String accessToken, String openId) {
        ...
        if (null != jsonObject) {
            try {
                ...
                weixinUserInfo.setSubscribe((Integer) jsonObject.get("subscribe"));
                // 用户关注时间
                weixinUserInfo.setSubscribeTime(jsonObject.getString("subscribe_time"));
                // 昵称
                weixinUserInfo.setNickname(jsonObject.getString("nickname"));
                // 用户的性别（1是男性，2是女性，0是未知）
                weixinUserInfo.setSex((Integer) jsonObject.get("sex"));
                // 用户所在国家
